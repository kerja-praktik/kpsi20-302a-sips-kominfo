            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="col-12 text-right">
                                <a href="{{route('page.index', 'tambah_jumlah_populasi_ternak_unggas')}}" class="btn btn-sm btn-default">Tambahkan Data</a>
                            </div>
                    ...
                    <a class="dropdown-item" href="{{route('page.index', 'peternakan_jumlah_populasi_ternak_unggas')}}">Jumlah Populasi Ternak Unggas</a>
                        ...
                        <div class="card-body table-full-width table-responsive">
                            ...
                            <a href="/peternakan_jumlah_populasi_ternak_unggas/hapus6/{{ $tabel6->id }}" class="btn btn-sm btn-danger">Hapus</a>
                                    ...
                                    <td><b><b>{{$jumlah23}}</td><b><b>
                                    <td><b><b>{{$jumlah24}}</td><b><b>
