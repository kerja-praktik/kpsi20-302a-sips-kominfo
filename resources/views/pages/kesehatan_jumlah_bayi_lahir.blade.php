            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="col-12 text-right">
                                <a href="{{route('page.index', 'formulir_jumlah_bayi_bblr')}}" class="btn btn-sm btn-default">Tambahkan Data</a>
                            </div>
                        ...
                        <div class="card-body table-full-width table-responsive">
                            ...
                            <a href="/kesehatan_jumlah_bayi_lahir/hapus/{{ $tabel30->id }}" class="btn btn-sm btn-danger">Hapus</a>
                                ...
                                <td></td>
                                    ...
                                    <td align="center"><b><b>{{$jumlah_bayi_lahir}}</td>
                                    <td align="center"><b><b>{{$jumlah_BBLR_jumlah}}</td>
                                    <td align="center"><b><b>{{$jumlah_BBLR_dirujuk}}</td>
                                    <td align="center"><b><b>{{$jumlah_BBLR_giji_buruk}}</td>
                                </tbody>
                            </table>
                        </div>
                    </div>
