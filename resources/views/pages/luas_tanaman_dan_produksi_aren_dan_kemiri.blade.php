            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="col-12 text-right">
                                <a href="{{route('page.index', 'tambah_luas_tanaman_dan_produksi_aren_dan_kemiri')}}" class="btn btn-sm btn-default">Tambahkan Data</a>
                            </div>
                    ...
                    <!-- </div> -->
                        ...
                        <div class="card-body table-full-widtd align="center" table-responsive" >
                            <table class="table table-hover table-striped">
                                ...
                                @foreach($tbl10 as $tabel10)
                                    <tr>
                                        ...
                                        <td align="center">{{$tabel10->luas_areal_aren}}</td>
                                        <td align="center">{{$tabel10->produksi_aren}}</td>
                                        <td align="center">{{$tabel10->produktivitas_aren}}</td>
                                        <td align="center">{{$tabel10->luas_areal_kemiri}}</td>
                                        <td align="center">{{$tabel10->produksi_kemiri}}</td>
                                        <td align="center">{{$tabel10->produktivitas_kemiri}}</td>
                            ...
                            <a href="/luas_tanaman_dan_produksi_aren_dan_kemiri/hapus10/{{ $tabel10->id }}" class="btn btn-sm btn-danger">Hapus</a>
                                    ...
                                    <td align="center">{{$jumlah37}}</td>
                                    <td align="center">{{$jumlah38}}</td>
                                    <td align="center">{{$jumlah39}}</td>
                                    <td align="center">{{$jumlah40}}</td>
                                    <td align="center">{{$jumlah41}}</td>
                                    <td align="center">{{$jumlah42}}</td>
