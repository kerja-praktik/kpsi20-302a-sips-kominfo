            ...
            <div class="col-md-12">
                ...
                <div class="col-md-12">
                    ...
                    <div class="col-12 text-right">
                                <a href="{{route('page.infrastruktur', 'formulir-pembagian_penetapan_besaran_alokasi_dana_desa')}}" class="btn btn-sm btn-primary">Tambahkan Data</a>
                            </div>
                        ...
                        <div class="card-body table-full-width table-responsive">
                            ...
                            @foreach($tbl51 as $tabel51)
                                <?php $i++; ?>
                                    ...
                                    <td align="center">
                                    <a href="{{ url('/edit9/'.$tabel51->id) }}" class="btn btn-sm btn-success">Edit</a>
                                        &nbsp
