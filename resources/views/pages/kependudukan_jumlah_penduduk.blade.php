            ...
            <div class="row">
                ...
                <div id="chart2">
                    ...
                    <div class="col-12 text-right">
                                <a href="{{route('page.index', 'formulir_jumlah_penduduk')}}" class="btn btn-sm btn-default">Tambahkan Data</a>
                            </div>
                        ...
                        <div class="card-body table-full-width table-responsive">
                            ...
                            <a href="/kependudukan_jumlah_penduduk/exportpdf21" class="btn btn-sm btn-warning"   >CETAK PDF</a>
                                ...
                                <?php $i++; ?>
                                    ...
                                    <td align="center">{{number_format($tabel21->laki_laki,2,",",".")}}</td>
                                    <td align="center">{{number_format($tabel21->perempuan,2,",",".")}}</td>
