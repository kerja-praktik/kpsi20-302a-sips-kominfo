    ...
    <div class="sidebar-wrapper">
        ...
        <ul class="nav">
            ...
            <li class="nav-item @if($activePage == 'table') active @endif">
                <a class="nav-link" href="{{route('page.infrastruktur', 'table')}}">
                    <!-- <i class="nc-icon nc-notes"></i> -->
                    <p>{{ __("Table List") }}</p>
                </a>
            </li>
            <li class="nav-item @if($activePage == 'typography') active @endif">
                <a class="nav-link" href="{{route('page.infrastruktur', 'typography')}}">
                    <!-- <i class="nc-icon nc-paper-2"></i> -->
                    <p>{{ __("Typography") }}</p>
                </a>
            </li>
            <li class="nav-item @if($activePage == 'icons') active @endif">
                <a class="nav-link" href="{{route('page.infrastruktur', 'icons')}}">
                    <!-- <i class="nc-icon nc-atom"></i> -->
                    <p>{{ __("Icons") }}</p>
                </a>
            </li>
            <li class="nav-item @if($activePage == 'maps') active @endif">
                <a class="nav-link" href="{{route('page.infrastruktur', 'maps')}}">
                    <!-- <i class="nc-icon nc-pin-3"></i> -->
                    <p>{{ __("Maps") }}</p>
                </a>
            </li>
            <li class="nav-item @if($activePage == 'notifications') active @endif">
                <a class="nav-link" href="{{route('page.infrastruktur', 'notifications')}}">
                    <!-- <i class="nc-icon nc-bell-55"></i> -->
                    <p>{{ __("Notifications") }}</p>
                </a>
            </li>
            <!-- <li class="nav-item">
                <a class="nav-link active bg-danger" href="{{route('page.infrastruktur', 'upgrade')}}">
                    <i class="nc-icon nc-alien-33"></i>
                    <p>{{ __("Upgrade to PRO") }}</p>
                </a>
            </li> -->
            <li class="nav-item @if($activePage == 'pemerintahan_jlh_desa_kel') active @endif">
                <a class="nav-link" href="{{route('page.index', 'pemerintahan_jlh_desa_kel')}}">
                    <!-- <i class="nc-icon nc-bell-55"></i> -->
                    <p>Pemerintahan</p>
                </a>
            </li>
            ...
            <li class="nav-item @if($activePage == 'kesehatan') active @endif">
                <a class="nav-link" href="{{route('page.index', 'kesehatan')}}">
                    <!-- <i class="nc-icon nc-bell-55"></i> -->
                    <p>Kesehatan</p>
                </a>
            </li>
            <li class="nav-item @if($activePage == 'pariwisata') active @endif">
                <a class="nav-link" href="{{route('page.index', 'pariwisata')}}">
                    <!-- <i class="nc-icon nc-bell-55"></i> -->
                    <p>Pariwisata</p>
                </a>
            </li>
            <li class="nav-item @if($activePage == 'pendidikan') active @endif">
                <a class="nav-link" href="{{route('page.index', 'pendidikan')}}">
                    <!-- <i class="nc-icon nc-bell-55"></i> -->
                    <p>Pendidikan</p>
                </a>
            </li>
            ...
            <li class="nav-item">
                ...
                <div class="collapse @if($activeButton =='laravel3') show @endif" id="laravel3">
                    <ul class="nav">
                        <li class="nav-item @if($activePage == 'user') active @endif">
                            <a class="nav-link"  href="{{route('page.infrastruktur', 'infrastruktur_aplikasi_opd_toba')}}">
                  
                                <p>Infrastruktur</p>
                            </a>
                        </li>
                        <li class="nav-item @if($activePage == 'user-management') active @endif">
                            <a class="nav-link" href="{{route('page.infrastruktur', 'infrastruktur_pembangunan_bersumber_dana_desa')}}">
                         
                                <p>Pembangunan</p>
                            </a>
                        </li>
                        <li class="nav-item @if($activePage == 'user-management') active @endif">
                            <a class="nav-link" href="{{route('page.infrastruktur', 'infrastruktur_pembagian_penetapan_besaran_alokasi_dana_desa')}}">
